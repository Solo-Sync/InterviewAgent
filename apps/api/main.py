...
from apps.api.response import err_payload
from apps.api.routes import admin, annotation, asr, evaluation, health, nlp, safety, scaffold, sessions
...
app.include_router(scaffold.router, prefix=settings.api_prefix)
