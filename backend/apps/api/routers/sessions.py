...
@router.get("/sessions/{session_id}", response_model=ApiResponseSessionGet)
def get_session(
    request: Request,
    session_id: str,
    orchestrator: OrchestratorService = Depends(get_orchestrator),
...
@router.post("/sessions/{session_id}/turns", response_model=ApiResponseTurnCreate)
def create_turn(
    request: Request,
    session_id: str,
...
@router.get("/sessions/{session_id}/turns", response_model=ApiResponseTurnList)
def list_turns(
    request: Request,
    session_id: str,
...
@router.post("/sessions/{session_id}/end", response_model=ApiResponseSessionEnd)
def end_session(
    request: Request,
    session_id: str,
...
@router.get("/sessions/{session_id}/report", response_model=ApiResponseReportGet)
def get_report(
    request: Request,
    session_id: str,
    orchestrator: OrchestratorService = Depends(get_orchestrator),
